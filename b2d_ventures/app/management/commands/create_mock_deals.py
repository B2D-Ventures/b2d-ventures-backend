...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        def create_placeholder_image(folder, filename):
            with open(f'/Users/krittinsetdhavanich/Downloads/b2d-ventures-backend/contentMockup/{folder}/{filename}', 'rb') as f:
        ...
        def create_mock_deals(startup_id):
            ...
            deal1 = Deal.objects.create(
                ...
                image_background=create_placeholder_image("NeurAI",
                                                          "neurai_background.jpeg"),
                image_logo=create_placeholder_image("NeurAI",
                                                    "neurai_logo.png"),
                image_content=create_placeholder_image("NeurAI",
                                                       "neurai_content.jpeg"),
                dataroom=create_placeholder_pdf("NeurAI",
                                                "neurai_dataroom.pdf"),
            ...
            deal2 = Deal.objects.create(
                ...
                image_background=create_placeholder_image("SolarFlare",
                                                          "solarflare_background.png"),
                image_logo=create_placeholder_image("SolarFlare",
                                                    "solarflare_logo.png"),
                image_content=create_placeholder_image("SolarFlare",
                                                       "solarflare_background.png"),
                dataroom=create_placeholder_pdf("SolarFlare",
                                                "solarflare_dataroom.pdf"),
            ...
            deal3 = Deal.objects.create(
                ...
                image_background=create_placeholder_image("GeneCure",
                                                          "genecure_background.jpg"),
                image_logo=create_placeholder_image("GeneCure",
                                                    "genecure_logo.jpg"),
                image_content=create_placeholder_image("GeneCure",
                                                       "genecure_background.jpg"),
                dataroom=create_placeholder_pdf("GeneCure",
                                                "genecure_dataroom.pdf"),
            ...
            deal4 = Deal.objects.create(
                ...
                image_background=create_placeholder_image("CryptoBank",
                                                          "cryptobank_background.jpeg"),
                image_logo=create_placeholder_image("CryptoBank",
                                                    "cryptobank_logo.jpeg"),
                image_content=create_placeholder_image("CryptoBank",
                                                       "cryptobank_content.jpeg"),
                dataroom=create_placeholder_pdf("CryptoBank",
                                                "cryptobank_dataroom.pdf"),
            ...
            deal5 = Deal.objects.create(
                ...
                image_background=create_placeholder_image("VertiFarm",
                                                          "vertifarm_background.png"),
                image_logo=create_placeholder_image("VertiFarm",
                                                    "vertifarm_logo.png"),
                image_content=create_placeholder_image("VertiFarm",
                                                       "vertifarm_background.png"),
                dataroom=create_placeholder_pdf("VertiFarm",
                                                "vertifarm_dataroom.pdf"),
