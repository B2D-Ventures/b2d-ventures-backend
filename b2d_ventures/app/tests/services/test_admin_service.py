...
class AdminServiceTestCase(TestCase):
  ...
  def test_list_deals(self):
      ...
      startup = Startup.objects.create(name="Test Startup", email="startup@example.com", username="teststartup")
  ...
  def test_list_investments(self):
      ...
      investor = Investor.objects.create(email='investor@example.com', username='investor')
      startup = Startup.objects.create(name="Test Startup", email="startup@example.com", username="teststartup")
  ...
  def test_get_dashboard_data(self):
      ...
      deal = Deal.objects.create(name='Test Deal', startup=startup)
      Investment.objects.create(deal=deal, investor=investor, investment_amount=1000)
      Meeting.objects.create(investor=investor, startup=startup, start_time=timezone.now() + timezone.timedelta(days=1))
  ...
  def test_delete_investment(self):
      ...
      startup = Startup.objects.create(name="Test Startup", email="startup@example.com", username="teststartup")
      deal = Deal.objects.create(name='Test Deal', startup=startup)
      investment = Investment.objects.create(deal=deal, investor=investor, investment_amount=1000)
